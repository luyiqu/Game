        ...
        private void OnRecvRegister(IChannel channel, Message message)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    //这里还需要插入playerID
                    var cmd3 = new NpgsqlCommand(string.Format("INSERT INTO player(username,password,working_value,luck_value,attack_value,gold_coin,silver_coin,hunting)VALUES('{0}','{1}',0,0,0,33,1000,FALSE)", username, password), conn3);
